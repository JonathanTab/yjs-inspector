  ...
  return (
    <div className="flex flex-col h-full">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600">Select a document to connect to</p>
      </div>
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-600">Room: {doc.room}</p>
                    <p className="text-sm text-gray-600">Owner: {doc.owner}</p>
                    {doc.tool && (
